...
function configure_retroarch() {
    ...
    local configdir_ra=$configdir/all/retroarch
    iniSet "assets_directory" "$configdir_ra/assets"
    iniSet "joypad_autoconfig_dir" "$configdir_ra/autoconfig"
    iniSet "cheat_database_path" "$configdir_ra/cheats"
    iniSet "rgui_config_directory" "$configdir_ra/config"
    iniSet "libretro_directory" "$configdir_ra/cores"
    iniSet "libretro_info_path" "$configdir_ra/cores"
    iniSet "content_database_path" "$configdir_ra/database/rdb"
    iniSet "core_assets_directory" "$configdir_ra/downloads"
    iniSet "audio_filter_dir" "$configdir_ra/filters/audio"
    iniSet "video_filter_dir" "$configdir_ra/filters/video"
    iniSet "log_dir" "$configdir_ra/logs"
    iniSet "overlay_directory" "$configdir_ra/overlays"
    iniSet "osk_overlay_directory" "$configdir_ra/overlays/keyboards"
    iniSet "playlist_directory" "$configdir_ra/playlists"
    iniSet "recording_output_directory" "$configdir_ra/records"
    iniSet "recording_config_directory" "$configdir_ra/records_config"
    iniSet "input_remapping_directory" "$configdir_ra/remaps"
    iniSet "screenshot_directory" "$configdir_ra/screenshots"
    mkdir -p "$configdir_ra/screenshots"
    iniSet "video_shader_dir" "$configdir_ra/shaders"
    iniSet "thumbnails_directory" "$configdir_ra/thumbnails"
    iniSet "content_favorites_directory" "$configdir_ra"
    iniSet "content_favorites_path" "$configdir_ra/content_favorites.lpl"
    iniSet "content_history_directory" "$configdir_ra"
    iniSet "content_history_path" "$configdir_ra/content_history.lpl"
    iniSet "content_image_history_directory" "$configdir_ra"
    iniSet "content_image_history_path" "$configdir_ra/content_image_history.lpl"
    iniSet "content_music_history_directory" "$configdir_ra"
    iniSet "content_music_history_path" "$configdir_ra/content_music_history.lpl"
    iniSet "content_video_directory" "$configdir_ra"
    iniSet "content_video_history_path" "$configdir_ra/content_video_history.lpl"
